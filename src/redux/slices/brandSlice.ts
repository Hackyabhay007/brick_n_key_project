...
export const fetchBrandSectionSlice = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await axios.get("https://strapi.bricknkey.com/api/brands?populate=brand_logo&populate[1]=brand_relations.property_Images&populate[2]=brand_relations.propertyFeature");
