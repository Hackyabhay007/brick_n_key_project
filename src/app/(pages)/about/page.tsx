        ...
        <>
            <div className="about_page_container w-full bg-bgColor">
                <div className="about_page_inner_container w-[90%] max-sm:w-[95%] 2xl:w-[80%] mx-auto pt-16 max-lg:pt-20 max-md:pt-16 max-sm:pt-12">
                    ...
                    <div className="about_us_info w-full mx-auto min-h-screen bg-cover max-lg:min-h-[auto] text-white grid grid-cols-2 px-12 py-16 max-xl:px-8 max-lg:grid-cols-1 gap-8 max-lg:gap-12 max-md:px-6 max-sm:px-4" style={{ backgroundImage: "url('/images/about_us_img_1.png')" }}>
                                    ...
                                    [
                                        ...
                                        return (
                                            <div key={index} className="flex flex-col gap-1">
                                                ...
                                                <h3 className="text-[18px] max-2xl:text-sm max-lg:text-[18px] max-md:text-[16px] max-sm:text-[14px] font-[600]">{currElem?.title}</h3>
